...
CREATE TABLE venta(
	...
	id_usuario INT NOT NULL,
	--cada venta completa (factura) estaría asociada directamente a una apertura de caja. Esto tiene sentido si consideras que todas las ventas realizadas durante un periodo de apertura de caja deben ser tratadas como una entidad única.
	id_apertura_caja INT NOT NULL, -- Agregamos el campo para asociar con la apertura de caja,asi cada venta va a estar relacionado con una apertura caja pudiendo e tratar cada venta completa como una entidad única. Puedes tener información general sobre la venta total al momento de manejar la caja 
