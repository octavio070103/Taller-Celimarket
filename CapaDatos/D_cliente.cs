        ...
        public DataTable buscarCliente(string pTerminoBusqueda, int pTipoBusqueda)
        {
            ...
            using (SqlConnection objConexion = new SqlConnection(CD_conexion.cadena))
            {
                ...
                try
                {
                    // Se instancia un objeto de la clase SqlCommand que servira para ejecutar comandos de la base 
                    // de datos
                    SqlCommand comando = new SqlCommand("SP_BuscarCliente", objConexion);

                    comando.Parameters.AddWithValue("@terminoBusqueda", pTerminoBusqueda);
                    comando.Parameters.AddWithValue("@tipoBusqueda", pTipoBusqueda);
